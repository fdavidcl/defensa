\documentclass[USenglish, aspectratio = 43]{beamer}
...
\section{Estado del arte en \textit{autoencoders}}

\section{Software desarrollado: Ruta}

\section{Aplicación a casos prácticos}

\section{Análisis de problemas supervisados}
